...
namespace NormalAnimal.Scripts.Player
{
    ...
    public class PlayerMove
    {
        ...
        [SerializeField] private float cameraDeltaY = 1;
        
        [SerializeField] private float accelForce = 5;
        [SerializeField] private float maxHorizontalVelocity = 1;
        ...
        public void Init(PlayerController owner)
        {
            ...
            _ownerRigidbody = owner.Rigidbody;
            _startedPosition = owner.transform.position;
            _groundChecker = new GroundChecker(_ownerTransform, _owner.Collider);
        ...
        private void checkAnimWalkByVel()
        {
            ...
            {
                _ownerAnimator.SetBool(_owner.HashRun.Code, true);
            }
            else
            {
                _ownerAnimator.SetBool(_owner.HashRun.Code, false);
            }
        }
